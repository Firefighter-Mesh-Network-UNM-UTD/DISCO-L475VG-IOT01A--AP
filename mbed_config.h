...
#define MBED_CONF_APP_SERVER_IP_3                      0           // set by application
#define MBED_CONF_APP_SERVER_IP_4                      106         // set by application
#define MBED_CONF_APP_WIFI_PASSWORD                    "PASS"      // set by application
